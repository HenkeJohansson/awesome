...
globalkeys = my_table.join(
    ...
    awful.key({ modkey,}, "p",
    function ()
        awful.spawn(string.format("dmenu_run -i -nb '#473B70' -nf '#E43D73' -sb '#E43D73' -sf '#473B70' -fn NotoMonoRegular:bold:pixelsize=14",
    ...
    awful.key({ modkey }, "F1", function () awful.util.spawn( "franz" ) end,
        {description = "Franz", group = "function keys"}),
    awful.key({ modkey }, "F2", function () awful.util.spawn( "slack" ) end,
        {description = "Slack" , group = "function keys" }),
    awful.key({ modkey }, "F3", function () awful.util.spawn( "teams" ) end,
        {description = "Mictrosoft Teams" , group = "function keys" }),
    ...
    awful.key({ modkey }, "F5", function () awful.util.spawn( "virtualbox" ) end,
        {description = "VirtualBox" , group = "function keys" }),

    -- super + ...
    awful.key({ modkey }, "c", function () awful.util.spawn( "code-oss" ) end,
        {description = "vscode", group = "super"}),
    ...
    awful.key({ modkey           }, "F12", function () awful.util.spawn( "xfce4-screenshooter" ) end,
